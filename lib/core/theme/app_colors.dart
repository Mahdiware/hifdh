...
class AppColors {
  ...
  // Core Brand Palette
  static const Color primaryNavy = Color(0xFF2C63B8);
  ...
  static const Color backgroundDark = Color(0xFF1B2336);

  // Surface / Card Colors
  static const Color surfaceLight = Colors.white;
  // A slightly lighter navy for cards in dark mode
  static const Color surfaceDark = Color(0xFF273B5D);

  // Text Colors
  static const Color textPrimaryLight = Color(0xFF23253A);
  static const Color textSecondaryLight = Color(0xFF5E6C7B);
