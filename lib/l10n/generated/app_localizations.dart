...
abstract class AppLocalizations {
  ...
  /// No description provided for @revisionQueueTitle.
  ///
  /// In en, this message translates to:
  /// **'Smart Revision Queue'**
  String get revisionQueueTitle;

  /// No description provided for @queueStartSession.
  ///
  /// In en, this message translates to:
  /// **'Start Session'**
  String get queueStartSession;

  /// No description provided for @queueSession.
  ///
  /// In en, this message translates to:
  /// **'Revision Session'**
  String get queueSession;

  /// No description provided for @queueSessionComplete.
  ///
  /// In en, this message translates to:
  /// **'Session complete'**
  String get queueSessionComplete;

  /// No description provided for @queueDue.
  ///
  /// In en, this message translates to:
  /// **'Due'**
  String get queueDue;

  /// No description provided for @queueWeak.
  ///
  /// In en, this message translates to:
  /// **'Weak'**
  String get queueWeak;

  /// No description provided for @queueMastered.
  ///
  /// In en, this message translates to:
  /// **'Mastered'**
  String get queueMastered;

  /// No description provided for @queueHighestPriority.
  ///
  /// In en, this message translates to:
  /// **'Highest Priority'**
  String get queueHighestPriority;

  /// No description provided for @queueOldestFirst.
  ///
  /// In en, this message translates to:
  /// **'Oldest Review'**
  String get queueOldestFirst;

  /// No description provided for @queueNoItems.
  ///
  /// In en, this message translates to:
  /// **'No ayahs in this queue'**
  String get queueNoItems;

  /// No description provided for @queueOptionalNote.
  ///
  /// In en, this message translates to:
  /// **'Optional note'**
  String get queueOptionalNote;

  /// No description provided for @queueMarkedCorrect.
  ///
  /// In en, this message translates to:
  /// **'Marked as correct'**
  String get queueMarkedCorrect;

  /// No description provided for @queueMarkedDoubt.
  ///
  /// In en, this message translates to:
  /// **'Marked as doubt'**
  String get queueMarkedDoubt;

  /// No description provided for @queueMarkedMistake.
  ///
  /// In en, this message translates to:
  /// **'Marked as mistake'**
  String get queueMarkedMistake;

  /// No description provided for @queueReasonNotMemorized.
  ///
  /// In en, this message translates to:
  /// **'Not memorized yet'**
  String get queueReasonNotMemorized;

  /// No description provided for @queueReasonMaintenance.
  ///
  /// In en, this message translates to:
  /// **'Maintenance review'**
  String get queueReasonMaintenance;

  /// No description provided for @queueReasonLastNeedsWork.
  ///
  /// In en, this message translates to:
  /// **'Last result needs work'**
  String get queueReasonLastNeedsWork;

  /// No description provided for @queueSettingsDescription.
  ///
  /// In en, this message translates to:
  /// **'Control queue size and mastered ayahs behavior'**
  String get queueSettingsDescription;

  /// No description provided for @queueIncludeMastered.
  ///
  /// In en, this message translates to:
  /// **'Include mastered ayahs'**
  String get queueIncludeMastered;

  /// No description provided for @queueIncludeMasteredDescription.
  ///
  /// In en, this message translates to:
  /// **'Show already-mastered ayahs in queue results'**
  String get queueIncludeMasteredDescription;

  /// No description provided for @queueDailyTarget.
  ///
  /// In en, this message translates to:
  /// **'Daily target: {target} ayahs'**
  String queueDailyTarget(int target);

  /// No description provided for @queueReasonMistakes.
  ///
  /// In en, this message translates to:
  /// **'Mistakes: {count}'**
  String queueReasonMistakes(int count);

  /// No description provided for @queueReasonDoubts.
  ///
  /// In en, this message translates to:
  /// **'Doubts: {count}'**
  String queueReasonDoubts(int count);

  /// No description provided for @queueReasonDays.
  ///
  /// In en, this message translates to:
  /// **'{days}d since review'**
