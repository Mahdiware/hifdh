class AyahSearchQuery {
  ...
  static AyahSearchQuery? parse(String query) {
    ...
    if (val != null) {
      // Ambiguous: Could be Surah 2 or Ayah 2? Defaults to Surah usually.
      // But user said "2:200 or 2 or 200".
      // Let's assume Filter by Surah if 1-114, otherwise maybe text search?
      // Actually common behavior: Typed "2" -> Matches Surah 2.
      // Typed "200" -> Matches Surah 200 (Invalid) or maybe user meant Ayah 200 of ANY surah?
      // Let's stick to: Single number = Surah Number.
      // If > 114, maybe treat as Ayah Number global? Unlikely useful.
      // Let's assume Surah Number.
